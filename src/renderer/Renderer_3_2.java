...
public class Renderer_3_2 {
	...
	private void setupShaders() {		
		...
		vsId = this.loadShader("resources/shaders/moving/vertex.glsl", 
				GL20.GL_VERTEX_SHADER);
		// Load the fragment shader
		fsId = this.loadShader("resources/shaders/moving/fragment.glsl", 
	...
	private void logicCycle() {
		...
		if(Keyboard.isKeyDown(Keyboard.KEY_1) && !Keyboard.isRepeatEvent())textureSelector = 0;
		if(Keyboard.isKeyDown(Keyboard.KEY_2) && !Keyboard.isRepeatEvent())textureSelector = 1;
		
		if(Keyboard.isKeyDown(Keyboard.KEY_LEFT))modelPos.x -= posDelta;
		if(Keyboard.isKeyDown(Keyboard.KEY_RIGHT))modelPos.x += posDelta;
		if(Keyboard.isKeyDown(Keyboard.KEY_DOWN))modelPos.y -= posDelta;
		if(Keyboard.isKeyDown(Keyboard.KEY_UP))modelPos.y += posDelta;
		
		if(Keyboard.isKeyDown(Keyboard.KEY_PERIOD))Vector3f.add(modelScale, scaleAddResolution, modelScale);
		if(Keyboard.isKeyDown(Keyboard.KEY_COMMA))Vector3f.add(modelScale, scaleMinusResolution, modelScale);

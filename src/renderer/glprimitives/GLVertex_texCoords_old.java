...
public class GLVertex_texCoords_old {
	...
	public GLVertex_texCoords_old() {
	}

	public GLVertex_texCoords_old(float x, float y, float z, float w, float r, float g, float b, float a, float s, float t) {
		this.xyzw = new float[] { x, y, z, w };
		this.rgba = new float[] { r, g, b, a };
		this.st = new float[] { s, t };
	}

	public GLVertex_texCoords_old(float x, float y, float z, float w, float[] rgba, float s, float t) {
		this.xyzw = new float[] { x, y, z, w };
		this.rgba = rgba;
		this.st = new float[] { s, t };
	}

	public GLVertex_texCoords_old(float x, float y, float z, float[] rgba, float s, float t) {
	...
	public float[] getElements() {
		float[] out = new float[GLVertex_texCoords_old.elementCount];
		int i = 0;

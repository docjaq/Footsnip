...
public class PlayerAlt extends Character {
	...
	private Vector3f scaleAddResolution;
	private Vector3f scaleMinusResolution;

	public PlayerAlt(GLModel model, String name, int age, float[] color) {
		super(model, name);
		this.age = age;
		this.color = color;

		this.scaleAddResolution = new Vector3f(scaleDelta, scaleDelta, scaleDelta);
		this.scaleMinusResolution = new Vector3f(-scaleDelta, -scaleDelta, -scaleDelta);
	}

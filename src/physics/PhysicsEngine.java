...
public class PhysicsEngine {
	...
	public PhysicsEngine() {
		...
		CollisionShape colShape = new BoxShape(new Vector3f(4f, 1f, 1f));
		float mass = 0f;
		Transform initialTransform = new Transform();
		initialTransform.setIdentity();
		initialTransform.origin.set(0f, -2f, 0f);
	...
	// This inner class is added as a global callback, and I think means that
	// friction and resitution is added to terrain.
